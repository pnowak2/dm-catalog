  ...
  describe('Api', () => {
    ...
    describe('.calculate()', () => {
      ...
      it('should move element to center bottom with offset', () => {
        ...
        expect(calculatedRect).toEqual(Rectangle.create(4.5, 8, 4, 3));
      });
      ...
      it('should move element to center bottom with offset & flip', () => {
        ...
        expect(calculatedRect).toEqual(Rectangle.create(4.5, -1, 4, 3));
      });
      ...
      it('should move element to center bottom with offset & flip & constrain', () => {
        ...
        expect(calculatedRect).toEqual(Rectangle.create(4.5, 0, 4, 3));
      });
    });
  });
});
