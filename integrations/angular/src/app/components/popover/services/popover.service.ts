...
export class PopoverService {
  ...
  calculate(placement: string, anchorRect: Rectangle, popoverRect: Rectangle, arrowRect: Rectangle): PopoverVM {
    ...
    return placementStrategy.calculate(anchorRect, popoverRect, arrowRect);
  }
}
