  ...
  describe('Markup', () => {
    describe('Default Appearance', () => {
      it('should render proper root element', async(() => {
        const root = debugElement.query(
          By.css('.asm-c-family-member:first-child')
        );
    ...
    describe('Selected / Unselected State', () => {
      it('should render selection when member selected', async(() => {
        ...
        const root = debugElement.query(
          By.css('.asm-c-family-member')
        );
        expect(root.classes['asm-c-family-member--selected']).toBeTruthy();
      }));
      ...
      it('should not render selection when member unselected', async(() => {
        ...
        expect(root.classes['asm-c-family-member--selected']).not.toBeTruthy();
      }));
    });
    ...
    describe('Enabled / Disabled State', () => {
      it('should render enabled when member enabled', async(() => {
        ...
        expect(root.classes['asm-c-family-member--disabled']).toBeFalsy();
      }));
      ...
      it('should render disabled properly when member disabled', async(() => {
        ...
        expect(root.classes['asm-c-family-member--disabled']).toBeTruthy();
      }));
    });
      ...
      describe('Relation & Personal number', () => {
        ...
        it('should render properly ex-relation if set to true', async(() => {
          ...
          const el = debugElement.query(
            By.css('.asm-c-family-member__member-relation')
          );

          expect(el.classes['asm-c-family-member__member-relation--ex']).toBeTruthy();
        }));
        ...
        it('should render properly ex-relation if set to false', async(() => {
          ...
          expect(el.classes['asm-c-family-member__member-relation--ex']).toBeFalsy();
        }));
        ...
        it('should not render personal number as a link if not covered by another affiliate', async(() => {
          ...
          const linkEl: DebugElement = debugElement.query(
            By.css('.asm-c-family-member__member-number')
          );
      ...
      describe('More menu', () => {
        it('should render the menu', async(() => {
          const menuEl: DebugElement = debugElement.query(
            By.css('.asm-c-family-member__more-menu')
          );
    ...
    describe('Main Data Section', () => {
      describe('Name of Member', () => {
        ...
        it('should render name tooltip if all data provided', () => {
          ...
          const el = debugElement.query(By.css('.asm-c-family-member__person-name'));
      ...
      describe('Dates', () => {
        it('should properly render birth date', async(() => {
          ...
          const el = fixture.debugElement.query(By.css('.asm-c-family-member__person-born'));
      ...
      describe('Languages', () => {
        it('should render main language section if language provided', async(() => {
          ...
          const langEl: DebugElement = debugElement.query(
            By.css('.asm-c-family-member__language')
          );
      ...
      describe('Badges', () => {
        describe('Comments', () => {
          it('should not render badge if no flag set', async(() => {
            ...
            const badgeEl: DebugElement = debugElement.query(
              By.css('.fa.fa-comment.asm-c-family-member__badge')
            );
        ...
        describe('Covered By Other Affiliate', () => {
          it('should render properly if no flag set', async(() => {
            ...
            const badgeEl: DebugElement = debugElement.query(
              By.css('.fa.fa-warning.asm-c-family-member__badge')
            );
            expect(badgeEl).toBeFalsy();
          }));
        ...
        describe('Sickness Coverage', () => {
          it('should render badge', async(() => {
            const badgeEl: DebugElement = debugElement.query(
              By.css('.fa.fa-heart.asm-c-family-member__badge')
            );
            expect(badgeEl).toBeTruthy();
          }));
          ...
          it('should render badge tooltip', () => {
            ...
            const badgeEl: DebugElement = debugElement.query(
              By.css('.asm-c-family-member__badge--sickness')
            );
          ...
          it('should render properly with no rights set', async(() => {
            ...
            expect(badgeEl.classes['asm-c-family-member__badge--complementary-rights']).toBeFalsy();
            expect(badgeEl.classes['asm-c-family-member__badge--full-rights']).toBeFalsy();
          }));
          ...
          it('should render properly with rights set to Complementary', async(() => {
            ...
            expect(badgeEl.classes['asm-c-family-member__badge--complementary-rights']).toBeTruthy();
            expect(badgeEl.classes['asm-c-family-member__badge--full-rights']).toBeFalsy();
          }));
          ...
          it('should render properly with rights set to Full', async(() => {
            ...
            expect(badgeEl.classes['asm-c-family-member__badge--complementary-rights']).toBeFalsy();
            expect(badgeEl.classes['asm-c-family-member__badge--full-rights']).toBeTruthy();
          }));
        });
        ...
        describe('Accident Coverage', () => {
          it('should render badge', async(() => {
            const badgeEl: DebugElement = debugElement.query(
              By.css('.fa.fa-plus.asm-c-family-member__badge')
            );
            expect(badgeEl).toBeTruthy();
          }));
          ...
          it('should render badge tooltip', () => {
            ...
            const badgeEl: DebugElement = debugElement.query(
              By.css('.asm-c-family-member__badge--accident')
            );
